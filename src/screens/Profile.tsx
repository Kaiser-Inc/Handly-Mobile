    ...
    return(
        <SafeAreaView className="flex-1 bg-white">
            ...
            <Center className=" w-full h-full items-center">
                ...
                <UserPhoto className=" w-32 h-32 rounded-full -mt-20 border-4 border-white bg-gray-400 " source={{uri: user?.profile_pic || "https://unavatar.io/substack/bankless"}} alt="Foto de perfil de usuário"/>
                <Text className=" font-bold text-2xl mt-8"> {user?.name || 'Carregando...'} </Text>
                <Text className=" text-gray-400 mt-4"> {user?.email || 'Carregando...'} </Text>
