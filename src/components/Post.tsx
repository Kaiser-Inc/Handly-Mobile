...
import { FolderMinus, Heart, MessageCircleMore, Send } from "lucide-react-native";
    ...
    return (
        <HStack className=" w-10/12 flex flex-col border border-gray-100 rounded-2xl mx-auto p-4">
            <VStack className=" flex flex-row w-11/12 mx-auto">
                <UserPhoto className=" w-14 h-14 rounded-2xl mr-4 " source={"https://github.com/pHenrymelo.png"} alt="Foto de perfil de usuário"/>
                <HStack className=" flex flex-col my-auto">
                    <Text className=" font-bold text-lg ">Pedro Melo</Text>
                    <Text className=" text-gray-300 font-thin text-sm ">Desenvolvedor freelancer</Text>
                </HStack>
            </VStack>
